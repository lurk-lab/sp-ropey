...
impl core::cmp::PartialEq for NodeText {
...
impl core::fmt::Display for NodeText {
    fn fmt(&self, fm: &mut core::fmt::Formatter) -> Result<(), core::fmt::Error> {
        NodeText::deref(self).fmt(fm)
    }
}

impl core::fmt::Debug for NodeText {
